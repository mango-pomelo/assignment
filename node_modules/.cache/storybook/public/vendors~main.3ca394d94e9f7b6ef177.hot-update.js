...
var Brush = /*#__PURE__*/function (_PureComponent) {
  ...
  _createClass(Brush, [{
    ...
    value: function getTextOfTick(index) {
      ...
      var text = Object(_util_ChartUtils__WEBPACK_IMPORTED_MODULE_7__[/* getValueByDataKey */ "s"])(data[index], dataKey, index);
...
var getRect = function getRect(hasX1, hasX2, hasY1, hasY2, props) {
  ...
  return Object(_util_CartesianUtils__WEBPACK_IMPORTED_MODULE_5__[/* rectWithPoints */ "c"])(p1, p2);
};
...
function ReferenceLine(props) {
  ...
  }, renderLine(shape, lineProps), _component_Label__WEBPACK_IMPORTED_MODULE_5__[/* Label */ "a"].renderCallByParent(props, Object(_util_CartesianUtils__WEBPACK_IMPORTED_MODULE_8__[/* rectWithCoords */ "b"])({
    x1: x1,
    y1: y1,
    x2: x2,
    y2: y2
...
var getTooltipContent = function getTooltipContent(state, chartData, activeIndex, activeLabel) {
  ...
  return graphicalItems.reduce(function (result, child) {
    ...
    return [].concat(_toConsumableArray(result), [Object(_util_ChartUtils__WEBPACK_IMPORTED_MODULE_26__[/* getTooltipItem */ "r"])(child, payload)]);
  }, []);
};
/**
...
var getAxisMapByAxes = function getAxisMapByAxes(props, _ref2) {
  ...
  var isCategorical = Object(_util_ChartUtils__WEBPACK_IMPORTED_MODULE_26__[/* isCategoricalAxis */ "t"])(layout, axisType); // Eliminate duplicated axes
  ...
  var axisMap = axes.reduce(function (result, child) {
    ...
    if (!result[axisId]) {
      ...
      if (dataKey) {
        // has dataKey in <Axis />
        domain = Object(_util_ChartUtils__WEBPACK_IMPORTED_MODULE_26__[/* getDomainOfDataByKey */ "i"])(displayedData, dataKey, type);
        ...
        if (type === 'category' && isCategorical) {
          ...
          if (allowDuplicatedCategory && duplicate) {
            ...
            domain = Object(_util_ChartUtils__WEBPACK_IMPORTED_MODULE_26__[/* parseDomainOfCategoryAxis */ "u"])(child.props.domain, domain, child).reduce(function (finalDomain, entry) {
          ...
          var errorBarsDomain = Object(_util_ChartUtils__WEBPACK_IMPORTED_MODULE_26__[/* parseErrorBarsOfAxis */ "v"])(displayedData, graphicalItems.filter(function (item) {
        ...
        if (isCategorical && (type === 'number' || scale !== 'auto')) {
          categoricalDomain = Object(_util_ChartUtils__WEBPACK_IMPORTED_MODULE_26__[/* getDomainOfDataByKey */ "i"])(displayedData, dataKey, 'category');
        }
        ...
        domain = stackOffset === 'expand' ? [0, 1] : Object(_util_ChartUtils__WEBPACK_IMPORTED_MODULE_26__[/* getDomainOfStackGroups */ "k"])(stackGroups[axisId].stackGroups, dataStartIndex, dataEndIndex);
      } else {
        domain = Object(_util_ChartUtils__WEBPACK_IMPORTED_MODULE_26__[/* getDomainOfItemsWithSameAxis */ "j"])(displayedData, graphicalItems.filter(function (item) {
          return item.props[axisIdKey] === axisId && !item.props.hide;
        }), type, true);
      }
      ...
      if (type === 'number') {
        ...
        if (child.props.domain) {
          domain = Object(_util_ChartUtils__WEBPACK_IMPORTED_MODULE_26__[/* parseSpecifiedDomain */ "x"])(child.props.domain, domain, allowDataOverflow);
        }
...
var getAxisMapByItems = function getAxisMapByItems(props, _ref3) {
  ...
  var len = displayedData.length;
  var isCategorical = Object(_util_ChartUtils__WEBPACK_IMPORTED_MODULE_26__[/* isCategoricalAxis */ "t"])(layout, axisType);
  ...
  var axisMap = graphicalItems.reduce(function (result, child) {
    ...
    if (!result[axisId]) {
      ...
      if (isCategorical) {
        ...
        domain = Object(_util_ChartUtils__WEBPACK_IMPORTED_MODULE_26__[/* getDomainOfStackGroups */ "k"])(stackGroups[axisId].stackGroups, dataStartIndex, dataEndIndex);
        ...
        domain = Object(_util_ChartUtils__WEBPACK_IMPORTED_MODULE_26__[/* parseSpecifiedDomain */ "x"])(Axis.defaultProps.domain, Object(_util_ChartUtils__WEBPACK_IMPORTED_MODULE_26__[/* getDomainOfItemsWithSameAxis */ "j"])(displayedData, graphicalItems.filter(function (item) {
          return item.props[axisIdKey] === axisId && !item.props.hide;
...
var tooltipTicksGenerator = function tooltipTicksGenerator(axisMap) {
  ...
  var tooltipTicks = Object(_util_ChartUtils__WEBPACK_IMPORTED_MODULE_26__[/* getTicksOfAxis */ "p"])(axis, false, true);
  return {
...
var generateCategoricalChart = function generateCategoricalChart(_ref6) {
  ...
  var getFormatItems = function getFormatItems(props, currentState) {
    ...
    graphicalItems.forEach(function (item, index) {
      ...
      var axisObj = axisComponents.reduce(function (result, entry) {
        ...
        return _objectSpread(_objectSpread({}, result), {}, (_objectSpread6 = {}, _defineProperty(_objectSpread6, entry.axisType, axis), _defineProperty(_objectSpread6, "".concat(entry.axisType, "Ticks"), Object(_util_ChartUtils__WEBPACK_IMPORTED_MODULE_26__[/* getTicksOfAxis */ "p"])(axis)), _objectSpread6));
      }, {});
      var cateAxis = axisObj[cateAxisName];
      var cateTicks = axisObj["".concat(cateAxisName, "Ticks")];
      var stackedData = stackGroups && stackGroups[numericAxisId] && stackGroups[numericAxisId].hasStack && Object(_util_ChartUtils__WEBPACK_IMPORTED_MODULE_26__[/* getStackedDataOfItem */ "o"])(item, stackGroups[numericAxisId].stackGroups);
  ...
  var updateStateOfAxisMapsOffsetAndStackGroups = function updateStateOfAxisMapsOffsetAndStackGroups(_ref7, prevState) {
    ...
    var stackGroups = Object(_util_ChartUtils__WEBPACK_IMPORTED_MODULE_26__[/* getStackGroupsByAxisId */ "n"])(data, graphicalItems, "".concat(numericAxisName, "Id"), "".concat(cateAxisName, "Id"), stackOffset, reverseStackOrder);
    var axisObj = axisComponents.reduce(function (result, entry) {
    ...
    function CategoricalChartWrapper(_props) {
      ...
      _this.verticalCoordinatesGenerator = function (_ref9) {
        var xAxis = _ref9.xAxis,
            ...
            height = _ref9.height,
            offset = _ref9.offset;
        return Object(_util_ChartUtils__WEBPACK_IMPORTED_MODULE_26__[/* getCoordinatesOfGrid */ "h"])(_cartesian_CartesianAxis__WEBPACK_IMPORTED_MODULE_22__[/* CartesianAxis */ "a"].getTicks(_objectSpread(_objectSpread(_objectSpread({}, _cartesian_CartesianAxis__WEBPACK_IMPORTED_MODULE_22__[/* CartesianAxis */ "a"].defaultProps), xAxis), {}, {
          ticks: Object(_util_ChartUtils__WEBPACK_IMPORTED_MODULE_26__[/* getTicksOfAxis */ "p"])(xAxis, true),
          viewBox: {
            x: 0,
            y: 0,
            width: width,
      ...
      _this.horizontalCoordinatesGenerator = function (_ref10) {
        ...
        return Object(_util_ChartUtils__WEBPACK_IMPORTED_MODULE_26__[/* getCoordinatesOfGrid */ "h"])(_cartesian_CartesianAxis__WEBPACK_IMPORTED_MODULE_22__[/* CartesianAxis */ "a"].getTicks(_objectSpread(_objectSpread(_objectSpread({}, _cartesian_CartesianAxis__WEBPACK_IMPORTED_MODULE_22__[/* CartesianAxis */ "a"].defaultProps), yAxis), {}, {
          ticks: Object(_util_ChartUtils__WEBPACK_IMPORTED_MODULE_26__[/* getTicksOfAxis */ "p"])(yAxis, true),
          viewBox: {
            x: 0,
            y: 0,
            width: width,
      ...
      _this.axesTicksGenerator = function (axis) {
        return Object(_util_ChartUtils__WEBPACK_IMPORTED_MODULE_26__[/* getTicksOfAxis */ "p"])(axis, true);
      };
      ...
      _this.renderPolarAxis = function (element, displayName, index) {
        ...
        return /*#__PURE__*/Object(react__WEBPACK_IMPORTED_MODULE_10__["cloneElement"])(element, _objectSpread(_objectSpread({}, axisOption), {}, {
          ...
          ticks: Object(_util_ChartUtils__WEBPACK_IMPORTED_MODULE_26__[/* getTicksOfAxis */ "p"])(axisOption, true)
        }));
      };
      ...
      _this.renderPolarGrid = function (element) {
        ...
        var props = element.props || {};
        return /*#__PURE__*/Object(react__WEBPACK_IMPORTED_MODULE_10__["cloneElement"])(element, {
          polarAngles: lodash_isArray__WEBPACK_IMPORTED_MODULE_9___default()(polarAngles) ? polarAngles : Object(_util_ChartUtils__WEBPACK_IMPORTED_MODULE_26__[/* getTicksOfAxis */ "p"])(angleAxis, true).map(function (entry) {
            return entry.coordinate;
          }),
          polarRadius: lodash_isArray__WEBPACK_IMPORTED_MODULE_9___default()(polarRadius) ? polarRadius : Object(_util_ChartUtils__WEBPACK_IMPORTED_MODULE_26__[/* getTicksOfAxis */ "p"])(radiusAxis, true).map(function (entry) {
            return entry.coordinate;
          }),
          cx: cx,
          cy: cy,
      ...
      _this.renderLegend = function () {
        ...
        var props = Object(_util_ChartUtils__WEBPACK_IMPORTED_MODULE_26__[/* getLegendProps */ "l"])({
          children: children,
          formatedGraphicalItems: formatedGraphicalItems,
      ...
      _this.renderActivePoints = function (_ref11) {
        ...
        var dotProps = _objectSpread(_objectSpread({
          ...
          cy: activePoint.y,
          r: 4,
          fill: Object(_util_ChartUtils__WEBPACK_IMPORTED_MODULE_26__[/* getMainColorOfGraphicItem */ "m"])(item.item),
          strokeWidth: 2,
          stroke: '#fff',
...
function LabelList(props) {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(_container_Layer__WEBPACK_IMPORTED_MODULE_7__[/* Layer */ "a"], {
    ...
    var value = lodash_isNil__WEBPACK_IMPORTED_MODULE_2___default()(dataKey) ? valueAccessor(entry, index) : Object(_util_ChartUtils__WEBPACK_IMPORTED_MODULE_9__[/* getValueByDataKey */ "s"])(entry && entry.payload, dataKey);
      ...
      var labels = sectors.map(function (entry, i) {
        ...
        return (
          ...
          react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(_container_Layer__WEBPACK_IMPORTED_MODULE_8__[/* Layer */ "a"], {
            key: "label-".concat(i)
          }, labelLine && Pie.renderLabelLineItem(labelLine, lineProps), Pie.renderLabelItem(label, labelProps, Object(_util_ChartUtils__WEBPACK_IMPORTED_MODULE_19__[/* getValueByDataKey */ "s"])(entry, realDataKey)))
        );
      });
...
Pie.getComposedData = function (_ref2) {
  ...
  var notZeroItemCount = pieData.filter(function (entry) {
    return Object(_util_ChartUtils__WEBPACK_IMPORTED_MODULE_19__[/* getValueByDataKey */ "s"])(entry, realDataKey, 0) !== 0;
  }).length;
  var totalPadingAngle = (absDeltaAngle >= 360 ? notZeroItemCount : notZeroItemCount - 1) * paddingAngle;
  var realTotalAngle = absDeltaAngle - notZeroItemCount * minAngle - totalPadingAngle;
  var sum = pieData.reduce(function (result, entry) {
    var val = Object(_util_ChartUtils__WEBPACK_IMPORTED_MODULE_19__[/* getValueByDataKey */ "s"])(entry, realDataKey, 0);
  ...
  if (sum > 0) {
    ...
    sectors = pieData.map(function (entry, i) {
      var val = Object(_util_ChartUtils__WEBPACK_IMPORTED_MODULE_19__[/* getValueByDataKey */ "s"])(entry, realDataKey, 0);
      var name = Object(_util_ChartUtils__WEBPACK_IMPORTED_MODULE_19__[/* getValueByDataKey */ "s"])(entry, nameKey, i);
      ...
      prev = _objectSpread(_objectSpread(_objectSpread({
        ...
        value: Object(_util_ChartUtils__WEBPACK_IMPORTED_MODULE_19__[/* getValueByDataKey */ "s"])(entry, realDataKey),
...
/*! exports used: createLabeledScales, rectWithCoords, rectWithPoints */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* unused harmony export formatAxisMap */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return rectWithPoints; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return rectWithCoords; });
...
var formatAxisMap = function formatAxisMap(props, axisMap, offset, axisType, chartName) {
  ...
  return ids.reduce(function (result, id) {
    ...
    var _parseScale = Object(_ChartUtils__WEBPACK_IMPORTED_MODULE_2__[/* parseScale */ "w"])(axis, chartName, hasBar),
        scale = _parseScale.scale,
        realScaleType = _parseScale.realScaleType;

    scale.domain(domain).range(range);
    Object(_ChartUtils__WEBPACK_IMPORTED_MODULE_2__[/* checkDomainOfScale */ "c"])(scale);
    var ticks = Object(_ChartUtils__WEBPACK_IMPORTED_MODULE_2__[/* getTicksOfScale */ "q"])(scale, _objectSpread(_objectSpread({}, axis), {}, {
...
/*! exports used: appendOffsetOfLegend, calculateActiveTickIndex, checkDomainOfScale, combineEventHandlers, getBandSizeOfAxis, getBarPosition, getBarSizeList, getCoordinatesOfGrid, getDomainOfDataByKey, getDomainOfItemsWithSameAxis, getDomainOfStackGroups, getLegendProps, getMainColorOfGraphicItem, getStackGroupsByAxisId, getStackedDataOfItem, getTicksOfAxis, getTicksOfScale, getTooltipItem, getValueByDataKey, isCategoricalAxis, parseDomainOfCategoryAxis, parseErrorBarsOfAxis, parseScale, parseSpecifiedDomain */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "s", function() { return getValueByDataKey; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "i", function() { return getDomainOfDataByKey; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return calculateActiveTickIndex; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "m", function() { return getMainColorOfGraphicItem; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "l", function() { return getLegendProps; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "v", function() { return parseErrorBarsOfAxis; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "j", function() { return getDomainOfItemsWithSameAxis; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "t", function() { return isCategoricalAxis; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "h", function() { return getCoordinatesOfGrid; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "p", function() { return getTicksOfAxis; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return combineEventHandlers; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "w", function() { return parseScale; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "n", function() { return getStackGroupsByAxisId; });
/* unused harmony export calculateDomainOfTicks */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "q", function() { return getTicksOfScale; });
/* unused harmony export getCateCoordinateOfLine */
/* unused harmony export getCateCoordinateOfBar */
/* unused harmony export getBaseValueOfBar */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "o", function() { return getStackedDataOfItem; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "k", function() { return getDomainOfStackGroups; });
/* unused harmony export MIN_VALUE_REG */
/* unused harmony export MAX_VALUE_REG */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "x", function() { return parseSpecifiedDomain; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return getBandSizeOfAxis; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "u", function() { return parseDomainOfCategoryAxis; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "r", function() { return getTooltipItem; });
/* harmony import */ var lodash_isEqual__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! lodash/isEqual */ "./node_modules/lodash/isEqual.js");
/* harmony import */ var lodash_isEqual__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(lodash_isEqual__WEBPACK_IMPORTED_MODULE_0__);
...
var formatAxisMap = function formatAxisMap(props, axisMap, offset, axisType, chartName) {
  ...
  return ids.reduce(function (result, id) {
    ...
    var _parseScale = Object(_ChartUtils__WEBPACK_IMPORTED_MODULE_2__[/* parseScale */ "w"])(axis, chartName),
        realScaleType = _parseScale.realScaleType,
        scale = _parseScale.scale;
...
//# sourceMappingURL=vendors~main.3ca394d94e9f7b6ef177.hot-update.js.map