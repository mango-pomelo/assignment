...
.e-checkboxfilter .e-icon-filter::before {
  content: '\e7ee';
}

.e-checkboxfilter .e-excl-filter-icon::before {
  content: '\e251';
}

.e-checkboxfilter .e-excl-filter-icon.e-filtered::before {
  content: '\e248';
}
...
.e-checkboxfilter .e-sortascending::before {
  content: '\e734';
}

.e-checkboxfilter .e-sortdescending::before {
  content: '\e733';
}
...
.e-bigger .e-dialog.e-checkboxfilter {
  min-width: 260px;
  min-height: 352px;
}

.e-bigger .e-dialog.e-checkboxfilter .e-dlg-content {
  padding-left: 11px;
}

.e-bigger .e-dialog.e-checkboxfilter .e-ftrchk,
.e-bigger .e-dialog.e-checkboxfilter .e-searchbox {
  padding-left: 13px;
}
...
.e-bigger.e-rtl .e-checkboxfilter .e-dlg-content {
  padding-left: 24px;
  padding-right: 11px;
}

.e-bigger.e-rtl .e-checkboxfilter .e-ftrchk,
.e-bigger.e-rtl .e-checkboxfilter .e-searchbox {
  padding-left: 0;
  padding-right: 13px;
}
...
.e-dialog.e-checkboxfilter .e-ftrchk,
.e-dialog.e-checkboxfilter .e-searchbox {
  padding-left: 9px;
}
...
.e-dialog.e-checkboxfilter .e-searchclear {
  float: right;
  position: relative;
}

.e-dialog.e-checkboxfilter .e-checkboxlist {
  height: 200px;
  margin-top: 5px;
  min-height: 160px;
  overflow-y: auto;
...
.e-dialog.e-checkboxfilter .e-chk-hidden {
  -moz-appearance: none;
  height: 1px;
  opacity: 0;
  width: 1px;
...
.e-dialog.e-checkboxfilter.e-rtl .e-dlg-content {
  padding-left: 18px;
  padding-right: 9px;
}

.e-dialog.e-checkboxfilter.e-rtl .e-ftrchk,
.e-dialog.e-checkboxfilter.e-rtl .e-searchbox {
  padding-left: 0;
  padding-right: 9px;
}

.e-dialog.e-checkboxfilter.e-rtl .e-searchclear {
  float: left;
  position: relative;
}
