    ...
    constructor(options, element) {
        ...
        this.objectEqualityChecker = (old, current) => {
            if (old) {
                ...
                let isEqual = true;
                let excludeKeys = ["Children", "childRecords", "taskData", "uniqueID", "parentItem", "parentUniqueID"];
                for (let i = 0; i < keys.length; i++) {
            ...
            if (this.parent.idMapping != null && (isNullOrUndefined(this.dropPosition) || this.dropPosition === 'bottomSegment')) {
                ...
                for (let i = 0; i < records.length; i++) {
                    if (records[i].hasChildRecords) {
                        ...
                        const child = records[i].childRecords;
...
class Page$1 {
    ...
    collapseExpandPagedchilds(rowDetails) {
        ...
        if (this.parent.enableImmutableMode) {
            ...
            let record = this.parent.flatData.filter(e => {
    ...
    beforeBatchDelete() {
        ...
        if (childs.length) {
            for (let i = 0; i < childs.length; i++) {
                const index = this.parent.grid.getRowIndexByPrimaryKey(childs[i][primarykey]);
...
class VirtualTreeContentRenderer extends VirtualContentRenderer {
    ...
    scrollListeners(scrollArgs) {
        ...
        const downScroll = (scrollArgs.offset.top - this.translateY) > scrollHeight;
